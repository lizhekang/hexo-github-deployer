...
function generator(obj) {
    ...
    function checkRemoved(commits) {
        var removed = commits && commits.removed ? commits.removed : [];
    ...
    return function(req, res) {
        ...
        if(hash == sha1) {
            if(ref == '' || 'refs/heads/' + ref == req.body.ref) {
                ...
                if(checkRemoved(body.commits)) {
                    // update cmdArray
                    cmdArray = removedCmd.concat(cmdArray);
                }
